...
# python -m Pyro5.nameserver --host 192.168.3.106 # roda cmd pra criar servidor de nomes com ip maquina - minha casa
# python -m Pyro5.nameserver --host 172.16.39.74 
...
def iniciar_thread(): # serve pra criar varias thread, varios clientes conectado ao mesmo tempo
    ...
    ns.register("servidor1", uri) # registra objeto servidor de nomes
    daemon.requestLoop()
