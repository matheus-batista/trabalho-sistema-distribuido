...
diretorio='C:\\Users\mathe\OneDrive\Área de Trabalho\sistema distribuido\sistema arquivos\servidor3' # diretorio fixo servidor
...
def iniciar_thread(): # serve pra criar varias thread, varios clientes conectado ao mesmo tempo
    ...
    ns.register("servidor3", uri) # registra objeto servidor de nomes
    daemon.requestLoop()
